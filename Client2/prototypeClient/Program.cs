...
namespace prototypeClient
{
    ...
    class Client
    {
        ...
        void ClientSetup(Client client)
        {
            ...
            client.msgReciever.CreateMessageServiceHost("http://localhost:8088/ICommService/BasicHttp");
            client.msgReciever.open();

            Console.WriteLine("Constructing host to download/upload files...");
            client.fileServer.CreateFileServiceHost("http://localhost:4048/ICommService/BasicHttp");
