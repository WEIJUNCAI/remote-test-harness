    ...
    class MessageClient
        {
            ...
            public Message SetupMessages(bool status, string info, string recipient)
            {
                Message msg = new Message();

                XElement LoadStatus = new XElement("LoadStatus");

                LoadStatus.Add(new XElement("Status", status));
                LoadStatus.Add(new XElement("LoadMessage", info));

                msg.sender = "Repository";
                msg.fileMessage.xmlLoadReply = LoadStatus.ToString();
